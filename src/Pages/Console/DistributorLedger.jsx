...
const DistributorLedger = () => {
    ...
    return (
        <main className=" md:p-2 overflow-hidden">
            <Toaster />
            <div className="w-xs md:w-full overflow-hidden max-w-7xl overflow-x-auto mx-auto bg-white/80 backdrop-blur-md shadow-xl rounded-xl p-2 py-10 border border-gray-200">
                {/* Header */}
                ...
                <div className="w-full mt-5 overflow-x-auto border border-gray-200">
                    <table className="w-full text-sm text-left">
                        <thead className="text-black capitalize font-bold">
                            <tr>
                                <td colSpan="15" className="text-right border border-gray-700 px-2 py-2">
                                    Closing Balance:
                                </td>
