...
const UpdateOfficeForm = () => {
  ...
  const { id, date, branch_name, address, factory_name, opening_balance } =
      ...
      <FormProvider {...methods} className="">
        ...
        >
          ...
          <div className="border border-gray-300 p-3 md:p-5 rounded-b-md">
            ...
            <div className="mt-5 md:mt-1 md:flex justify-between gap-3">
              <div className="w-full">
                              <InputField type="number" name="opening_balance" label="Opening Balance" defaultValue={opening_balance} />
                            </div>
              <div className="w-full">
                <InputField
                  name="address"
